...
SHADOW_HAND_LITE_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        asset_path=f"/home/ayush/Desktop/gap/roto/roto/assets/shadow_lite/sr_hand_touchlab.urdf",  # change path
    ...
    actuators={
        "fingers": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                # Distal joints (fingertips) — J1 now actuated, no longer a mimic
                "rh_[MRF]FJ1": 2.5,#0.7245,
                # Proximal and Middle joints
                "rh_[MRF]FJ[23]": 2.5,#0.9,
            ...
            stiffness={
                # raised 1.0 -> 3.0 to reduce position-tracking lag vs hardware
                "rh_[MRF]FJ[1-4]": 1.0,
                "rh_THJ[1245]": 1.0,
            },
            damping={
                # kept ~10:1 stiffness:damping ratio
                "rh_[MRF]FJ[1-4]": 0.1,
                "rh_THJ[1245]": 0.1,
            },
        ),
